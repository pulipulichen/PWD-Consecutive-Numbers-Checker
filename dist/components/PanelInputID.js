...
// Module
exports.push([module.i, "", "",{"version":3,"sources":[],"names":[],"mappings":"","file":"PanelInputID.less?vue&type=style&index=0&id=37708022&lang=less&scoped=true&"}]);
    ...
    _c("div", { staticClass: "ui top attached buttons" }, [
      _c(
        ...
        [
          ...
          _vm._v(
            "\n      " + _vm._s(_vm.$t("How to list file names?")) + "\n    "
          )
        ]
      ),
      _vm._v(" "),
